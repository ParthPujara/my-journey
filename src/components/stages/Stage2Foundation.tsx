...
export default function Stage2Foundation({ containerRef }: { containerRef: React.RefObject<HTMLDivElement | null> }) {
    ...
    <div ref={containerRef} className="flex min-h-[120vh] w-full items-center justify-center p-8">
      <motion.div style={{ opacity, y }} className="max-w-xl">
        ...
        <p className="mb-8 text-xl font-light leading-relaxed tracking-wide text-white/70 md:text-3xl">
          Every great structure begins with a strong foundation. Mine started with learning the fundamentals of the web.
        </p>
        <div className="flex flex-wrap gap-3">
          {['HTML', 'CSS', 'Basic JavaScript', 'Fundamentals'].map((skill) => (
