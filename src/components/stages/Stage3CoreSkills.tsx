...
export default function Stage3CoreSkills({ containerRef }: { containerRef: React.RefObject<HTMLDivElement | null> }) {
    ...
    <div ref={containerRef} className="flex min-h-[120vh] w-full items-center justify-center p-8">
      <motion.div style={{ opacity, y }} className="max-w-xl">
        ...
        <p className="mb-8 text-xl font-light leading-relaxed tracking-wide text-white/70 md:text-3xl">
          Structure gives strength. This phase represents building my core programming knowledge.
        </p>
        <div className="flex flex-wrap gap-3">
          {['JavaScript', 'Data Structures', 'Algorithms', 'Problem Solving'].map((skill) => (
